<div class="bg-holder">
    ...
    <div class="bg-blur" style="background-image:url({{ Theme::url() }}/img/1280x848.png);"></div>
            ...
            <div class="row row-wrap">
                <div class="col-md-4">
                    ...
                    <div class="testimonial text-white">
                        ...
                        <div class="testimonial-author">
                            <img src="{{ Theme::url('img/50x50.png') }}" alt="Image Alternative text" title="Sevenly Shirts - June 2012  2" />
                ...
                <div class="col-md-4">
                    ...
                    <div class="testimonial text-white">
                        ...
                        <div class="testimonial-author">
                            <img src="{{ Theme::url('img/50x50.png') }}" alt="Image Alternative text" title="Flare lens flare" />
                ...
                <div class="col-md-4">
                    ...
                    <div class="testimonial text-white">
                        ...
                        <div class="testimonial-author">
                            <img src="{{ Theme::url('img/50x50.png') }}" alt="Image Alternative text" title="Afro" />
