<div class="bg-darken blog-posts border-t-1">
    <div class="container">
        <div class="gap"></div>
        <h2 class="text-center">@lang('themes::news.latest news')</h2>
        <div class="gap"></div>
                    ...
                    <div class="thumb">
                        ...
                        <header class="thumb-header">
                            <a class="hover-img curved" href="{{ $post->url }}">
                                <img class="img-responsive img-thumbnail img-rounded lazyloader" src="{{ $image }}" alt="{{ $post->title }}" title="{{ $post->title }}" /><i class="fa fa-link box-icon-white box-icon-border hover-icon-top-right round"></i>
                            </a>
                        </header>
                        @endif
                        @unset($image)
